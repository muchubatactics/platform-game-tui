...
a - left\
d - right\
[ENTER] - advance when on state screens
...
to format you'll need to have `clang-format-diff` installed
...
`xset` command works on linux with X11,\
on console you can use `kdbrate -d 200 -r 20`\
